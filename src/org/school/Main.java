...
public class Main {
    public static void main(String[] args) {
        Teacher teacher1 = new Teacher(1,"teacher1",5000);
        Teacher teacher2 = new Teacher(2,"teacher2",7000);
        Teacher teacher3 = new Teacher(3,"teacher3",9000);
        ...
        Teacher teacher4 = new Teacher(6,"teacher4", 1000);

        college1.addTeacher(teacher4);


        student1.payFees(25000);
